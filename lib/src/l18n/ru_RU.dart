...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'titleSimilar': 'Similar title',
      'tagOverlap': 'Tag overlap',
      'importantTagOverlap': 'Artist/original/character overlap',
      ...
      'batchTagFillReady': 'Готово',
      'batchTagFillReadyHint': 'Проверьте настройки и нажмите Начать',
      'batchTagFillCollectingTargets': 'Сбор элементов без тегов',
      'batchTagFillFilteringTargets': 'Фильтрация текущего диапазона',
      'batchTagFillTargetCount': 'Элементов к обработке: %s',
      'batchTagFillPrepareFailed': 'Ошибка подготовки',
      'batchTagFillFailed': 'Ошибка',
      ...
      'batchTagFillStrictness': 'Строгость совпадения',
      'batchTagFillStrictnessStrict': 'Строго',
      'batchTagFillStrictnessBalanced': 'Сбалансировано (по умолчанию)',
      'batchTagFillStrictnessLoose': 'Свободно',
      'start': 'Начать',
      ...
      'librarySearchHint': 'Search title, uploader, path, or tags',
      'sortBy': 'Sort By',
