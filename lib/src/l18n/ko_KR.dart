...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'batchTagFillReady': '시작 대기',
      'batchTagFillReadyHint': '설정을 확인한 뒤 시작을 누르세요',
      'batchTagFillCollectingTargets': '태그가 없는 항목 수집 중',
      'batchTagFillFilteringTargets': '현재 범위 필터링 중',
      'batchTagFillTargetCount': '처리 대상: %s',
      'batchTagFillPrepareFailed': '준비 실패',
      'batchTagFillFailed': '실패',
      'candidateTitle': '후보',
      'retry': '다시 시도',
      ...
      'batchTagFillStrictness': '일치 엄격도',
      'batchTagFillStrictnessStrict': '엄격',
      'batchTagFillStrictnessBalanced': '균형(기본)',
      'batchTagFillStrictnessLoose': '느슨함',
      'start': '시작',
