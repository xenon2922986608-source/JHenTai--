...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'mangaLibrary': '漫画库',
      'similarManga': '相似漫画',
      'mangaSimilarityAllDone': '已处理完全部相似漫画，暂无相似漫画。',
      'backToMangaLibrary': '返回漫画库',
      'selectedTags': '已选标签',
      'andLogic': '与',
      ...
      'organized': '已整理',
      'notOrganized': '未整理',
      'markAsOrganized': '标记为已整理',
      'cancelOrganized': '取消已整理',
      'organizedSaved': '已标记为已整理',
      'organizedCanceled': '已取消已整理标记',
      'organizedStatus': '整理状态',
      'organizedUpdatedAt': '整理状态更新时间',
      'organizedOnly': '仅绿标',
      'unorganizedOnly': '非绿标',
      'all': '全部',
      'batchFillTags': '批量补全 tags',
      'batchFillMissingTags': '批量补全缺失 tags',
      'batchTagFillNoTargets': '没有需要补全 tags 的漫画',
      'batchTagFillStatus': '当前状态',
      'batchTagFillReady': '待开始',
      'batchTagFillReadyHint': '请确认设置后点击开始',
      'batchTagFillCollectingTargets': '正在收集无 tag 条目',
      'batchTagFillFilteringTargets': '正在过滤当前范围',
      'batchTagFillTargetCount': '待处理条目数量：%s',
      'batchTagFillPrepareFailed': '准备失败',
      'batchTagFillFailed': '已失败',
      'candidateTitle': '当前候选',
      'retry': '重试',
      'batchTagFillPreparing': '准备中',
      'batchTagFillSearching': '正在搜索',
      'batchTagFillFetchingDetail': '正在读取详情',
      'batchTagFillWritingTags': '正在写入 tags',
      'batchTagFillCancelling': '正在取消',
      'batchTagFillCancelled': '已取消',
      'batchTagFillCompleted': '已完成',
      'batchTagFillMultipleExact': '多个精确匹配',
      'batchTagFillNoExact': '无精确匹配',
      'batchTagFillNoExactMatch': '没有精确标题匹配',
      'batchTagFillMultipleExactMatches': '存在多个精确标题匹配',
      'batchTagFillDetailTitleMismatch': '详情标题不完全匹配',
      'batchTagFillChinesePreferred': '已选择唯一汉语精确匹配',
      'batchTagFillMultipleChinese': '存在多个汉语精确匹配',
      'batchTagFillNoChinese': '没有汉语精确匹配',
      'batchTagFillUnknownLanguage': '无法可靠判断候选语言',
      'batchTagFillStrictness': '匹配严格度',
      'batchTagFillStrictnessStrict': '严格',
      'batchTagFillStrictnessBalanced': '平衡（默认）',
      'batchTagFillStrictnessLoose': '宽松',
      'start': '开始',
      'batchTagFillResultDetails': '结果详情',
      'refreshSimilarityResults': '刷新相似结果',
      'currentItem': '当前条目',
      'cleanedTitle': '清洗后标题',
      'progress': '进度',
      'close': '关闭',
      ...
      'allTypes': '全部类型',
      'allCategories': '全部分类',
      'librarySearchHint': '搜索标题、上传者、路径或标签',
      'sortBy': '排序',
      ...
      'pdfRead': 'PDF 阅读',
      'openingPdf': '正在打开 PDF...',
      'pdfFileNotFound': 'PDF 文件不存在，请重新扫描下载目录。',
      'pdfOpenFailed': '无法打开 PDF',
      'pdfReadFailed': '无法读取 PDF',
      'pdfReadPermissionDenied': '无法读取 PDF，请检查文件权限或重新扫描下载目录。',
      'currentPage': '当前页',
      'totalPages': '总页数',
      'restorePdfReadProgress': '已恢复上次阅读位置',
      'restorePdfReadProgressFailed': '恢复 PDF 阅读位置失败',
      'savePdfReadProgressFailed': '保存 PDF 阅读位置失败',
      'pdfReadUnsupportedPlatform': 'PDF 阅读暂不支持当前平台。',
      'pdfPageCountInvalid': '无法读取 PDF 页数',
      'prevPage': '上一页',
      'nextPage': '下一页',
      ...
      'fillTags': '补全 tags',
      'searchKeyword': '搜索关键词',
      'tagFillKeywordHint': '可修改关键词后搜索 E-Hentai/ExHentai 候选',
      'localManga': '本地漫画',
      'tagFillCandidates': '候选条目',
      'viewCandidateDetail': '查看候选详情',
      'useThisCandidate': '使用此条目补全 tags',
      'confirmFillTags': '确认补全 tags？',
      'confirmFillTagsHint': '是否将“%s”的 tags 保存到当前本地漫画“%s”？',
      'tagFillCancelled': '已取消补全 tags',
      'tagFillSaved': 'tags 已保存',
      'tagFillSearchFailed': '搜索候选失败',
      'tagFillCandidateDetailFailed': '加载候选详情失败',
      'tagFillSaveFailed': '保存 tags 失败',
      'noTagFillCandidates': '未找到候选条目',
      'candidateHasNoTags': '候选条目没有 tags',
      'mangaLibraryNoSourceGallery': '当前条目没有可用来源画廊',
      'sourceGalleryUrl': '来源画廊链接',
      'sourceTitle': '来源标题',
      'tagUpdatedAt': 'Tags 更新时间',
      'manualEditTags': '手动编辑 tags',
      'manualTagInputHint': '每次输入一个 tag，格式为 namespace:value；支持中文冒号和中文 namespace，例如“女性：巨乳”。点击已有 tag 可编辑，点 x 可删除。',
      'manualTagEmptyHint': '当前没有 tags，请在下方新增。',
      'manualTagInputExample': '例如：女性：巨乳 或 female:big breasts',
      'manualTagSave': '保存 tags',
      'tagSuggestions': '自动联想',
      'manualTagInvalidFormat': 'tag 格式错误，请使用 namespace:value',
      'manualTagDuplicate': '重复 tag',
      'searchSourceAgain': '重新搜索来源',
      'openOnlineDetail': '打开在线详情',
      'goToDownloadOrRedownload': '前往下载 / 重新下载',
      'sourceLinkStatus': '来源关联',
      'sourceLinked': '已关联 E-Hentai 页面',
      'sourceNotLinked': '未关联 E-Hentai 页面',
      'sourceCategory': '来源分类',
      'sourceUploader': '来源上传者',
      'sourceGalleryIncomplete': '来源 gid/token 或链接不完整，无法打开在线详情',
      'originalTitle': '原始标题',
      'autoSearchKeyword': '自动生成的搜索关键词',
      'metadataStatus': 'metadata',
      'metadataLinked': '已关联本地 metadata',
      'metadataNotWritten': '未写入文件夹 metadata',
      'metadataPath': 'metadata 文件',
      'writeLibraryMetadata': '写入 metadata 文件',
      'libraryMetadataWriteSuccess': 'metadata 文件已写入',
      'libraryMetadataWriteFailed': 'metadata 文件写入失败',
      'libraryMetadataReadFailed': 'metadata 文件读取失败',
      'exportAllLibraryMetadata': '导出所有漫画库 metadata',
      'exportAllLibraryMetadataHint': '将已有 importedFolder/PDF 的 tags 和来源信息同步写入文件夹旁 metadata 文件。',
      'libraryMetadataExportResult': 'metadata 导出结果',
      'successCount': '成功数量',
      'failureCount': '失败数量',
      'conflictCount': '冲突数量',
      'libraryMetadataConflict': 'metadata 冲突',
      'libraryMetadataSidecarNewer': 'sidecar metadata 更新或 tags 更多，已跳过覆盖',
