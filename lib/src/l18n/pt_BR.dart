...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      'similarManga': 'Mangás similares',
      'mangaSimilarityAllDone': 'All similar manga have been handled. No similar manga is available.',
      'backToMangaLibrary': 'Back to Manga Library',
      ...
      'similarityReasons': 'Motivos',
      'titleSimilar': 'Título similar',
      'tagOverlap': 'Tags em comum',
      'importantTagOverlap': 'Autor/original/personagem em comum',
      ...
      'organized': 'Organized',
      'notOrganized': 'Not organized',
      'markAsOrganized': 'Mark as organized',
      'cancelOrganized': 'Cancel organized',
      'organizedSaved': 'Marked as organized',
      'organizedCanceled': 'Organized mark canceled',
      'organizedStatus': 'Organized status',
      'organizedUpdatedAt': 'Organized updated at',
      'organizedOnly': 'Only organized',
      'unorganizedOnly': 'Not organized',
      'all': 'All',
      'batchFillTags': 'Batch fill tags',
      'batchFillMissingTags': 'Batch fill missing tags',
      'batchTagFillNoTargets': 'No manga needs tag filling',
      'batchTagFillStatus': 'Status',
      'batchTagFillReady': 'Pronto',
      'batchTagFillReadyHint': 'Confirme as configurações e toque em Iniciar',
      'batchTagFillCollectingTargets': 'Coletando itens sem tags',
      'batchTagFillFilteringTargets': 'Filtrando escopo atual',
      'batchTagFillTargetCount': 'Itens a processar: %s',
      'batchTagFillPrepareFailed': 'Falha ao preparar',
      'batchTagFillFailed': 'Falhou',
      'candidateTitle': 'Candidato',
      'retry': 'Tentar novamente',
      'batchTagFillPreparing': 'Preparing',
      'batchTagFillSearching': 'Searching',
      'batchTagFillFetchingDetail': 'Reading detail',
      'batchTagFillWritingTags': 'Writing tags',
      'batchTagFillCancelling': 'Cancelling',
      'batchTagFillCancelled': 'Cancelled',
      'batchTagFillCompleted': 'Completed',
      'batchTagFillMultipleExact': 'Multiple exact matches',
      'batchTagFillNoExact': 'No exact match',
      'batchTagFillNoExactMatch': 'No exact title match',
      'batchTagFillMultipleExactMatches': 'Multiple exact title matches',
      'batchTagFillDetailTitleMismatch': 'Detail title does not exactly match',
      'batchTagFillChinesePreferred': 'Selected the only Chinese exact match',
      'batchTagFillMultipleChinese': 'Multiple Chinese exact matches',
      'batchTagFillNoChinese': 'No Chinese exact match',
      'batchTagFillUnknownLanguage': 'Unable to reliably determine candidate language',
      'batchTagFillStrictness': 'Rigor da correspondência',
      'batchTagFillStrictnessStrict': 'Rigoroso',
      'batchTagFillStrictnessBalanced': 'Equilibrado (padrão)',
      'batchTagFillStrictnessLoose': 'Flexível',
      'start': 'Iniciar',
      'batchTagFillResultDetails': 'Result details',
      'refreshSimilarityResults': 'Refresh similarity results',
      ...
      'librarySearchHint': 'Buscar título, uploader, caminho ou tags',
      'sortBy': 'Ordenar por',
      ...
      'downloadExperimental': 'Manga Library Experimental Tools',
      'downloadExperimentalHint': 'Scan the current download path and sync existing local content to Manga Library.',
      'changeDownloadPathInDownloadSetting': 'To change this path, use Download Path in Download Settings.',
      'rescanDownloadDirectory': 'Rescan Download Directory',
      'rescanDownloadDirectoryHint': 'Restore JHenTai metadata records and import local folders/PDF files into Manga Library.',
      'scanResult': 'Scan Result',
      'lastScanTime': 'Last Scan Time',
      'importedFolderCount': 'Imported folder count',
      'importedPdfCount': 'Imported PDF count',
      'updatedImportedCount': 'Updated imported count',
      ...
      'pdfFileNotFound': 'PDF file does not exist. Please rescan the download directory.',
      'pdfOpenFailed': 'Unable to open PDF',
      'pdfReadFailed': 'Unable to read PDF',
      'pdfReadPermissionDenied': 'Unable to read PDF. Please check file permissions or rescan the download directory.',
      'currentPage': 'Current page',
      'totalPages': 'Total pages',
      'restorePdfReadProgress': 'Restored last reading position',
      'restorePdfReadProgressFailed': 'Failed to restore PDF reading position',
      'savePdfReadProgressFailed': 'Failed to save PDF reading position',
      'pdfReadUnsupportedPlatform': 'PDF reading is not supported on this platform yet.',
      'pdfPageCountInvalid': 'Unable to read PDF page count',
      ...
      'tagFillKeywordHint': 'Edit keyword to search E-Hentai/ExHentai candidates',
      'localManga': 'Local manga',
      'tagFillCandidates': 'Tag candidates',
      'viewCandidateDetail': 'View candidate detail',
      'useThisCandidate': 'Use this candidate',
      'confirmFillTags': 'Fill tags?',
      'confirmFillTagsHint': 'Save tags from "%s" to local manga "%s"?',
      'tagFillCancelled': 'Tag fill cancelled',
      'tagFillSaved': 'Tags saved',
      'tagFillSearchFailed': 'Candidate search failed',
      'tagFillCandidateDetailFailed': 'Candidate detail failed',
      'tagFillSaveFailed': 'Failed to save tags',
      'noTagFillCandidates': 'No tag candidates found',
      'candidateHasNoTags': 'Candidate has no tags',
      'mangaLibraryNoSourceGallery': 'No source gallery is available for this item',
      'sourceGalleryUrl': 'Source gallery URL',
      'sourceTitle': 'Source title',
      'tagUpdatedAt': 'Tags updated at',
      'manualEditTags': 'Edit tags manually',
      'manualTagInputHint': 'Enter one tag at a time as namespace:value. Chinese colons and Chinese namespaces are supported. Tap an existing tag to edit it, or x to delete it.',
      'manualTagEmptyHint': 'There are no tags yet. Add one below.',
      'manualTagInputExample': 'Example: 女性：巨乳 or female:big breasts',
      'manualTagSave': 'Save tags',
      'tagSuggestions': 'Suggestions',
      'manualTagInvalidFormat': 'Invalid tag format. Use namespace:value.',
      'manualTagDuplicate': 'Duplicate tag',
      'searchSourceAgain': 'Search source again',
      'openOnlineDetail': 'Open online detail',
      'goToDownloadOrRedownload': 'Go to download / redownload',
      'sourceLinkStatus': 'Source link',
      'sourceLinked': 'Linked to an E-Hentai page',
      'sourceNotLinked': 'Not linked to an E-Hentai page',
      'sourceCategory': 'Source category',
      'sourceUploader': 'Source uploader',
      'sourceGalleryIncomplete': 'Source gid/token or URL is incomplete. Cannot open online detail.',
      'originalTitle': 'Original title',
      'autoSearchKeyword': 'Auto search keyword',
      'metadataStatus': 'metadata',
      'metadataLinked': 'Linked local metadata',
      'metadataNotWritten': 'Folder metadata not written',
      'metadataPath': 'metadata file',
      'writeLibraryMetadata': 'Write metadata file',
      'libraryMetadataWriteSuccess': 'Metadata file written',
      'libraryMetadataWriteFailed': 'Failed to write metadata file',
      'libraryMetadataReadFailed': 'Failed to read metadata file',
      'exportAllLibraryMetadata': 'Export all Manga Library metadata',
      'exportAllLibraryMetadataHint': 'Write existing imported folder/PDF tags and source info to sidecar metadata files.',
      'libraryMetadataExportResult': 'Metadata export result',
      'successCount': 'Success count',
      'failureCount': 'Failure count',
      'conflictCount': 'Conflict count',
      'libraryMetadataConflict': 'Metadata conflict',
      'libraryMetadataSidecarNewer': 'Sidecar metadata is newer or has more tags; skipped overwrite',
