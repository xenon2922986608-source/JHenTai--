...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'batchTagFillReady': '待開始',
      'batchTagFillReadyHint': '請確認設定後點擊開始',
      'batchTagFillCollectingTargets': '正在收集無 tag 條目',
      'batchTagFillFilteringTargets': '正在過濾目前範圍',
      'batchTagFillTargetCount': '待處理條目數量：%s',
      'batchTagFillPrepareFailed': '準備失敗',
      'batchTagFillFailed': '已失敗',
      'candidateTitle': '目前候選',
      'retry': '重試',
      ...
      'pdfRead': 'PDF 閱讀',
      'openingPdf': '正在開啟 PDF...',
      'pdfFileNotFound': 'PDF 檔案不存在，請重新掃描下載目錄。',
      'pdfOpenFailed': '無法開啟 PDF',
      'pdfReadFailed': '無法讀取 PDF',
      'pdfReadPermissionDenied': '無法讀取 PDF，請檢查檔案權限或重新掃描下載目錄。',
      'currentPage': '目前頁',
      'totalPages': '總頁數',
      'restorePdfReadProgress': '已恢復上次閱讀位置',
      'restorePdfReadProgressFailed': '恢復 PDF 閱讀位置失敗',
      'savePdfReadProgressFailed': '儲存 PDF 閱讀位置失敗',
      'pdfReadUnsupportedPlatform': 'PDF 閱讀暫不支援目前平台。',
      'pdfPageCountInvalid': '無法讀取 PDF 頁數',
      'prevPage': '上一頁',
      'nextPage': '下一頁',
